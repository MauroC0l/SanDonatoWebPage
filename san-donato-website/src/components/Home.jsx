...
export default function Home() {
    ...
    useEffect(() => {
        ...
        }, 60000); // cambia immagine ogni 60 secondi
    ...
    const mockNews = [
        {
            ...
            excerpt:
                "La scuola calcio apre le iscrizioni per tutti i bambini dai 6 ai 12 anni. Vieni a provare i nostri allenamenti! Bla bla bla, divertimento assicurato per tutti."
        },
        {
            id: 2,
            ...
            excerpt:
                "Si terrà il torneo di pallavolo giovanile presso la palestra comunale. Tutti i team sono benvenuti!"
        },
        {
            id: 3,
            ...
            excerpt:
                "Iscriviti al nuovo corso di basket per principianti! Allenamenti divertenti, tecniche base e tanto spirito di squadra."
        },
        {
            id: 4,
            ...
            excerpt:
                "Il camp estivo PSD è aperto a tutti i bambini dai 6 ai 14 anni. Sport, giochi e nuove amicizie garantiti!"
        },
        {
            id: 5,
            ...
            excerpt:
                "Non perderti il torneo di calcetto per adulti! Squadre miste e tanto divertimento. Iscrizioni aperte fino al 5 Novembre."
        },
        {
            id: 6,
            ...
            image: "pilates.jpg",
            excerpt:
                "Partecipa alle nostre lezioni di ginnastica posturale per migliorare postura, flessibilità e benessere quotidiano."
        }
    ];
            ...
            >
                <div className="about-content">
                    ...
                    <p className="about-text">
                        ...
                        favorendo aggregazione, socialità e benessere sul
                        territorio.
                    </p>
                </div>
